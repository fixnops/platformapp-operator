...
KIND_CLUSTER ?= platformapp-operator-test-e2e
...
docker-buildx: ## Build and push docker image for the manager for cross-platform support
	...
	- $(CONTAINER_TOOL) buildx create --name platformapp-operator-builder
	$(CONTAINER_TOOL) buildx use platformapp-operator-builder
	...
	- $(CONTAINER_TOOL) buildx rm platformapp-operator-builder
	rm Dockerfile.cross
